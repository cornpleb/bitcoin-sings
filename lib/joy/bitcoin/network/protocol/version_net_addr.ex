defmodule Joy.Bitcoin.Network.Protocol.VersionNetAddr do
  @moduledoc """
  ...
  alias Joy.Bitcoin.Network.Protocol.VersionNetAddr
...
defimpl Joy.Bitcoin.Network.Protocol,
  for: Joy.Bitcoin.Network.Protocol.VersionNetAddr do
  alias Joy.Bitcoin.Network.Protocol.VersionNetAddr
